  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      <div className="flex justify-between items-start mb-6">
        ...
        <button onClick={() => setShowForm(true)} className="bg-gray-900 text-sm text-white px-4 py-2 rounded-lg hover:bg-gray-800">
          New Type
        </button>
      </div>
      ...
      {showForm && (
        <div className="p-4 border border-gray-300 rounded-lg mb-4">
          ...
          <NewTypeForm onSubmit={handleCreateType} onCancel={() => setShowForm(false)} />
              ...
              <div key={t.id} className="flex items-center justify-between py-3">
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    {t.pricePerPerson != null && ` • $${Number(t.pricePerPerson).toFixed(2)}`}
                  </div>
                </div>
